  ...
  for (let i = 0; i < finalArray.length; i++) {
    ...
    if (finalArray[i].branch === "branchA" || finalArray[i].branch === "branchB") {
      ...
      if (i !== 0) {
        ...
        let memberId = finalArray[i].referedByMemberId;
        if (i === 1) {
          if (finalArray[0].branch === "branchC") {
          ...
          if (finalArray[1].branch === "branchC") {
            if (finalArray[0].branch === "branchC") {
          ...
          if (finalArray[2].branch === "branchC") {
            if (finalArray[1].branch === "branchC") {
              if (finalArray[0].branch === "branchC") {
          ...
          if (finalArray[3].branch === "branchC") {
            if (finalArray[2].branch === "branchC") {
              if (finalArray[1].branch === "branchC") {
                if (finalArray[0].branch === "branchC") {
          ...
          if (finalArray[4].branch === "branchC") {
            if (finalArray[3].branch === "branchC") {
              if (finalArray[2].branch === "branchC") {
                if (finalArray[1].branch === "branchC") {
                  if (finalArray[0].branch === "branchC") {
          ...
          if (finalArray[5].branch === "branchC") {
            if (finalArray[4].branch === "branchC") {
              if (finalArray[3].branch === "branchC") {
                if (finalArray[2].branch === "branchC") {
                  if (finalArray[1].branch === "branchC") {
