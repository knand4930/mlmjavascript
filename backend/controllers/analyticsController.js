...
const analyticsController = {
  ...
  getAnalyticsAdmin: async (req, res, next) => {
    try {
      ...
      const nonWorkingIncentiveDataAdmin = await NonWorkingSchema.find();

      const leadershipRewardsDataAdmin = await LeadershipRewardsSchema.find();
